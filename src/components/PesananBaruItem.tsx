...
export interface PesananBaruItemProps {
	item: {
		id: number;
		name: string;
		variation: string;
...
const PesananBaruItem: React.FC<PesananBaruItemProps> = ({ item }) => {
	return (
		<div className="border p-4 rounded-lg mb-4 bg-white shadow-sm">
			...
			<div className="flex justify-between items-center mt-4">
				<p className="text-[#182958] text-sm">
					Paket perlu segera diproses sebelum {item.deadline}
				</p>
...
export default PesananBaruItem;
